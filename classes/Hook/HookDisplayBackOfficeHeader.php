...
use PrestaShop\Module\Ps_Oldgoogleanalytics\Wrapper\OrderWrapper;
...
class HookDisplayBackOfficeHeader implements HookInterface
{
    ...
    public function run()
    {
        ...
        $ga_account_id = Configuration::get('GA_OLDACCOUNT_ID');
        ...
        if (!empty($ga_account_id) && $this->module->active) {
            ...
            $this->context->smarty->assign('GA_OLDACCOUNT_ID', $ga_account_id);
