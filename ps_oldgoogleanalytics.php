...
class Ps_Oldgoogleanalytics extends Module
{
    /**
    ...
    {
        $this->name = 'ps_oldgoogleanalytics';
        ...
        $this->displayName = $this->l('UNIVERSAL Google Analytics');
    ...
    {
        $configurationForm = new PrestaShop\Module\Ps_Oldgoogleanalytics\Form\ConfigurationForm($this);
        $formOutput = '';
    ...
    {
        $hook = new PrestaShop\Module\Ps_Oldgoogleanalytics\Hooks\HookDisplayHeader($this, $this->context);
    ...
    {
        $hook = new PrestaShop\Module\Ps_Oldgoogleanalytics\Hooks\HookDisplayOrderConfirmation($this, $this->context);
    ...
    {
        $hook = new PrestaShop\Module\Ps_Oldgoogleanalytics\Hooks\HookDisplayFooter($this, $this->context);
    ...
    {
        $hook = new PrestaShop\Module\Ps_Oldgoogleanalytics\Hooks\HookDisplayHome($this, $this->context);
    ...
    {
        $hook = new PrestaShop\Module\Ps_Oldgoogleanalytics\Hooks\HookDisplayFooterProduct($this, $this->context);
        $hook->setParams($params);
    ...
    {
        $gaTagHandler = new PrestaShop\Module\Ps_Oldgoogleanalytics\Handler\GanalyticsJsHandler($this, $this->context);

        $output = $gaTagHandler->generate(
            $this->context->cookie->__get('oldga_admin_refund'),
            true
        );
        $this->context->cookie->__unset('oldga_admin_refund');
    ...
    {
        $hook = new PrestaShop\Module\Ps_Oldgoogleanalytics\Hooks\HookDisplayBackOfficeHeader($this, $this->context);
    ...
    {
        $hook = new PrestaShop\Module\Ps_Oldgoogleanalytics\Hooks\HookActionProductCancel($this, $this->context);
        $hook->setParams($params);
        $hook->run();
    }
    ...
    {
        $hook = new PrestaShop\Module\Ps_Oldgoogleanalytics\Hooks\HookActionOrderStatusPostUpdate($this, $this->context);
        $hook->setParams($params);
        $hook->run();
    }
    ...
    {
        $hook = new PrestaShop\Module\Ps_Oldgoogleanalytics\Hooks\HookActionCartSave($this, $this->context);
        $hook->run();
    }

    public function hookActionCarrierProcess($params)
    {
        $hook = new PrestaShop\Module\Ps_Oldgoogleanalytics\Hooks\HookActionCarrierProcess($this, $this->context);
        $hook->setParams($params);
        $hook->run();
    }
    ...
    {
        $moduleHandler = new PrestaShop\Module\Ps_Oldgoogleanalytics\Handler\ModuleHandler();
        $database = new PrestaShop\Module\Ps_Oldgoogleanalytics\Database\Install($this);

        $moduleHandler->uninstallModule(self::PS_16_EQUIVALENT_MODULE);

        // Disable normal module
        $regularModule = Module::getInstanceByName('ps_googleanalytics');
        if ($regularModule instanceof Module && Module::isInstalled('ps_googleanalytics') && $regularModule->active) {
            $regularModule->disable();
        }
    ...
    {
        $database = new PrestaShop\Module\Ps_Oldgoogleanalytics\Database\Uninstall();
